...
| #  | 项目                                                                                                                                                 | Stars | 语言         | 类型               | 简介                                                                                                           |
| -- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ----- | ---------- | ---------------- | ------------------------------------------------------------------------------------------------------------ |
| 1  | [KeygraphHQ/shannon](https://github.com/KeygraphHQ/shannon) ⭐ 47,243 \| 🐛 30 \| 🌐 TypeScript \| 📅 2026-08-26                                    | 45.6k | TypeScript | 渗透 Agent         | 面向 Web 应用和 API 的自主白盒 AI 渗透测试工具                                                                               |
| 2  | [usestrix/strix](https://github.com/usestrix/strix) ⭐ 58,698 \| 🐛 319 \| 🌐 Python \| 📅 2026-08-27                                               | 41.0k | Python     | 渗透 Agent         | 开源 AI 黑客，发现并修复应用漏洞                                                                                           |
| 3  | [promptfoo/promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,616 \| 🐛 530 \| 🌐 TypeScript \| 📅 2026-08-27                                 | 23.2k | TypeScript | LLM 红队           | LLM 应用红队/渗透/漏洞扫描，OpenAI、Anthropic 在用                                                                         |
| 4  | [vxcontrol/pentagi](https://github.com/vxcontrol/pentagi) ⭐ 22,046 \| 🐛 50 \| 🌐 Go \| 📅 2026-08-06                                              | 20.3k | Go         | 渗透 Agent         | 全自主 AI 代理系统，执行复杂渗透测试任务                                                                                       |
| 5  | [GreyDGL/PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,099 \| 🐛 70 \| 🌐 Python \| 📅 2026-07-14                                        | 14.2k | Python     | 渗透 Agent         | LLM 驱动的自动化渗透测试代理框架（早期标杆）                                                                                     |
...
| 10 | [Ed1s0nZ/CyberStrikeAI](https://github.com/Ed1s0nZ/CyberStrikeAI) ⭐ 6,010 \| 🐛 55 \| 🌐 Go \| 📅 2026-08-26                                       | 5.1k  | Go         | 渗透 Agent         | Go 构建的 AI 原生安全测试平台                                                                                           |
| 11 | [elder-plinius/T3MP3ST](https://github.com/elder-plinius/T3MP3ST) ⭐ 5,690 \| 🐛 3 \| 🌐 TypeScript \| 📅 2026-08-24                                | 4.6k  | TypeScript | 红队 Agent         | 自主红队平台 / 多智能体进攻性安全元框架，复用本机 AI 编码代理（Claude Code/Codex/Ollama 等）作零日漏洞猎手                                        |
| 12 | [microsoft/PyRIT](https://github.com/microsoft/PyRIT) ⭐ 4,366 \| 🐛 92 \| 🌐 Python \| 📅 2026-08-26                                               | 4.1k  | Python     | LLM 红队           | 生成式 AI 风险识别工具（Microsoft）                                                                                     |
| 13 | [GH05TCREW/pentestagent](https://github.com/GH05TCREW/pentestagent) ⭐ 3,012 \| 🐛 28 \| 🌐 Python \| 📅 2026-08-04                                 | 2.8k  | Python     | 渗透 Agent         | 黑盒安全测试 AI Agent 框架（GHOSTCREW）                                                                                |
...
| 15 | [samugit83/redamon](https://github.com/samugit83/redamon) ⭐ 2,354 \| 🐛 14 \| 🌐 Python \| 📅 2026-08-23                                           | 2.2k  | Python     | 红队 Agent         | AI 驱动的代理式红队框架                                                                                                |
| 16 | [confident-ai/deepteam](https://github.com/confident-ai/deepteam) ⭐ 2,624 \| 🐛 60 \| 🌐 Python \| 📅 2026-08-21                                   | 2.1k  | Python     | LLM 红队           | DeepTeam — LLM 红队测试框架                                                                                        |
...
| 18 | [0xSteph/pentest-ai-agents](https://github.com/0xSteph/pentest-ai-agents) ⭐ 2,167 \| 🐛 2 \| 🌐 Shell \| 📅 2026-08-16                             | 2.0k  | Shell      | Claude SubAgent  | 将 Claude Code 转为攻击性安全研究助手                                                                                    |
...
| 24 | [0xSteph/pentest-ai](https://github.com/0xSteph/pentest-ai) ⭐ 1,630 \| 🐛 2 \| 🌐 Python \| 📅 2026-08-20 <small>*⭐新补充*</small>                    | 1.3k  | Python     | 渗透 Agent         | MCP 服务器封装 205+ 安全工具 + 17 个专业代理 + 确定性漏洞验证（零误报），CLI + MCP 双路径，自带 LLM                                           |
...
| 26 | [CyberStrikeus/CyberStrike](https://github.com/CyberStrikeus/CyberStrike) ⭐ 2,048 \| 🐛 25 \| 🌐 TypeScript \| 📅 2026-08-27 <small>*⭐新补充*</small> | 1.2k  | TypeScript | 渗透 Agent         | AI 驱动的进攻性安全代理，7,300+ 安全技能，基于 MITRE ATT\&CK / CIS / OWASP / NIST，含网站 [cyberstrike.io](https://cyberstrike.io) |
...
| 28 | [bugbasesecurity/pentest-copilot](https://github.com/bugbasesecurity/pentest-copilot) ⭐ 1,330 \| 🐛 28 \| 🌐 TypeScript \| 📅 2026-08-14           | 1.1k  | JavaScript | 浏览器助手            | 浏览器端的道德黑客辅助工具                                                                                                |
| 29 | [berylliumsec/nebula](https://github.com/berylliumsec/nebula) ⭐ 1,094 \| 🐛 9 \| 🌐 Python \| 📅 2026-08-27                                        | 1.1k  | Python     | 渗透助手             | AI 渗透助手，自动侦察 / 笔记 / 漏洞分析                                                                                     |
...
| - | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- | ---------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| 1 | [mukul975/Anthropic-Cybersecurity-Skills](https://github.com/mukul975/Anthropic-Cybersecurity-Skills) ⭐ 31,323 \| 🐛 42 \| 🌐 Python \| 📅 2026-08-24 <small>*⭐新补充*</small> | 26.1k | Agent Skills（agentskills.io 标准，20+ 平台兼容） | 🔥 **全球最大开源网安 Agent Skill 库**，817 个结构化技能覆盖 29 大安全域（红队/渗透/云安全/取证/威胁狩猎等），业界唯一六框架映射（ATT\&CK/NIST CSF/ATLAS/D3FEND/AI RMF/F3），社区非官方项目 |
...
| # | 仓库                                                                                                                                            | Stars | 语言            | 定位与特色                                                                                                                              |
| - | --------------------------------------------------------------------------------------------------------------------------------------------- | ----- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| 1 | [PortSwigger/mcp-server](https://github.com/portswigger/mcp-server) ⭐ 1,110 \| 🐛 52 \| 🌐 Kotlin \| 📅 2026-08-14                            | 990   | Kotlin        | **PortSwigger 官方**出品，Burp Suite 扩展，桥接 Burp 与 MCP 客户端（Claude Desktop 等），SSE + Stdio 双模式                                             |
...
| A27 | 2024-11 | [PentestAgent: Incorporating LLM Agents to Automated Penetration Testing](https://arxiv.org/abs/2411.05185)                                                           | Xiangmin Shen et al.                    | ASIA CCS 2025         | [GH05TCREW/pentestagent](https://github.com/GH05TCREW/pentestagent) ⭐ 3,012 \| 🐛 28 \| 🌐 Python \| 📅 2026-08-04     |
...
| A36 | 2023-08 | [PentestGPT: An LLM-empowered Automatic Penetration Testing Tool](https://arxiv.org/abs/2308.06782)                                                                   | Gelei Deng et al. (NTU)                 | USENIX Security 2024  | [GreyDGL/PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,099 \| 🐛 70 \| 🌐 Python \| 📅 2026-07-14            |
...
> 注：会议/期刊年份为论文实际收录会议届期；arXiv 时间为 v1 提交月份。来源致谢：[tmylla/Awesome-LLM4Cybersecurity](https://github.com/tmylla/Awesome-LLM4Cybersecurity) ⭐ 1,761 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-20、[EvanThomasLuke/Awesome-AI-Hacking-Agents](https://github.com/EvanThomasLuke/Awesome-AI-Hacking-Agents) ⭐ 647 | 🐛 3 | 📅 2026-08-10、[ox01024/awesome-offensive-security-ai](https://github.com/ox01024/awesome-offensive-security-ai)。
...
| 3 | [ottosulin/awesome-ai-security](https://github.com/ottosulin/awesome-ai-security) ⭐ 1,428 \| 🐛 151 \| 📅 2026-08-27                                                       | 1.0k  | ottosulin      | 通用 AI 安全资源集合（攻防兼顾）                                                                   |
...
| 7 | [EvanThomasLuke/Awesome-AI-Hacking-Agents](https://github.com/EvanThomasLuke/Awesome-AI-Hacking-Agents) ⭐ 647 \| 🐛 3 \| 📅 2026-08-10                                     | 258   | EvanThomasLuke | AI Hacking Agent 全景 + AIxCC 决赛队伍 + 商业产品 + 论文                                         |
